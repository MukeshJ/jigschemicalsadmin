...
export class ContactUsService {
    ...
    getContactUsList(
        ...
        const customParams = new HttpParams()
            ...
            .set('comapany', resourceParams.comapany ? resourceParams.comapany : '')
            .set(
                'type',
                resourceParams.type !== null && resourceParams.type !== undefined
                    ? resourceParams.type
                    : ''
            );
    ...
    downloadResume(id: string): Observable<Blob> {
        return this.httpClient.get(`contactus/${id}/resume/download`, {
            responseType: 'blob'
        });
    }
}
